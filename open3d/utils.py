...
def initialize_camera(intrinsic, extrinsic, width, height, scale):
    camera = o3d.geometry.LineSet.create_camera_visualization(view_width_px=width, view_height_px=height, intrinsic=intrinsic, extrinsic=extrinsic, scale=scale)
    return camera